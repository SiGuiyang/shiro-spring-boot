 ...
 * <tt>destroy()</tt> methods on Shiro objects that implement the {@link Initializable}
 * or {@link Destroyable} interfaces, respectfully.  This post processor makes it easier
...
public class LifecycleBeanPostProcessor implements DestructionAwareBeanPostProcessor, PriorityOrdered {
    ...
    /**
     * Calls the <tt>init()</tt> methods on the bean if it implements {@link Initializable}
     *
    ...
    /**
     * Calls the <tt>destroy()</tt> methods on the bean if it implements {@link Destroyable}
     *
     * @param object the object being initialized.
     * @param name   the name of the bean being initialized.
     * @throws BeansException if any exception is thrown during initialization.
